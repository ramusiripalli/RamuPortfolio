...
function Navbar(){
    return <nav className="mb-20 flex items-center justify-between py-6">
        ...
        <a href="https://drive.google.com/file/d/18gC7Riiwxl4Z58skvtSBPLBct7Yn9PQQ/view?usp=sharing" target="_blank" className="animate-bounce w-6 h-6"><abbr title="Resume"><FaFileDownload /></abbr></a>
