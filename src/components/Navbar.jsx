...
function Navbar(){
    return <nav className="mb-20 flex items-center justify-between py-6">
        ...
        <a href="https://drive.google.com/file/d/1YAN-ImP4zhP7X_WfnvwXo7sFDNRv5tHR/view?usp=drive_link " target="_blank" className="animate-bounce w-6 h-6"><abbr title="Resume"><FaFileDownload /></abbr></a>
