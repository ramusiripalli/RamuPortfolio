...
function Navbar(){
    return <nav className="mb-20 flex items-center justify-between py-6">
        ...
        <a href="https://drive.google.com/file/d/1C1Tc7XWsC4k_8knMHJrNp5MdgncGFyyj/view?usp=sharing" target="_blank" className="animate-bounce w-6 h-6"><abbr title="Resume"><FaFileDownload /></abbr></a>
